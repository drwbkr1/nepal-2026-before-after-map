...
class M2DemProj25MetadataRecovery001ReviewTests(unittest.TestCase):
    ...
    def test_static_blank_packet_remains_preserved_after_exact_approval(self) -> None:
        ...
        expected = "M2-RADAR-DELAYED-IMPORT-PROBE-001-REVIEW-PUBLICATION"
        ...
        self.assertEqual(self.goal["proposed_amendments"], ["contracts/milestone-002-radar-delayed-import-probe-001-proposal.json"])
