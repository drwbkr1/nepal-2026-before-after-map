...
class M2RadarDelayedImportProbe001ReviewTests(unittest.TestCase):
    ...
    def test_canonical_state_routes_to_execution_gate_publication(self) -> None:
        ...
        self.assertEqual(goal["proposed_amendments"], ["contracts/milestone-002-radar-apply-orbit-correction-input-resolution-diagnostic-001-proposal.json"])
        ...
        self.assertFalse(current_radar_delayed_import_probe_001_final_preflight_pending(ROOT, {"promoted": 8}))
        self.assertTrue(current_radar_delayed_import_probe_001_terminal(ROOT, {"promoted": 8}))
