...
class M2RadarPixelOrbitApplication001ReviewTests(unittest.TestCase):
    ...
    def test_control_state_matches_terminal_block(self) -> None:
        ...
        pending_recovery = ["contracts/milestone-002-radar-delayed-import-probe-001-proposal.json"]
        ...
        self.assertEqual(self.goal["active_amendments"][-1], "records/source-gates/m2-radar-pixel-orbit-application-recovery-001-approval.json")
        self.assertEqual(self.profile["control_surfaces"]["activated_amendments"][-1], "records/source-gates/m2-radar-pixel-orbit-application-recovery-001-approval.json")
        if published:
