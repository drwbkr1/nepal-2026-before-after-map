...
class M2CheckpointReconciliationTests(unittest.TestCase):
    ...
    def test_exact_recovery_result_is_terminal_without_retry(self) -> None:
        ...
        self.assertFalse(current_optical_pixel_implementation_pending(ROOT, {"promoted": 8}))
        self.assertFalse(current_optical_pixel_recovery_review_required(ROOT, {"promoted": 8}))
        self.assertFalse(current_optical_pixel_recovery_implementation_pending(ROOT, {"promoted": 8}))
        self.assertFalse(current_optical_pixel_recovery_execution_pending(ROOT, {"promoted": 8}))
        self.assertTrue(current_optical_pixel_recovery_terminal(ROOT, {"promoted": 8}))
        self.assertFalse(current_radar_first_path_review_required(ROOT, {"promoted": 8}))
        self.assertFalse(current_orbit_recovery_002_review_required(ROOT, {"promoted": 8}))
        self.assertFalse(current_orbit_recovery_003_review_required(ROOT, {"promoted": 8}))
        self.assertFalse(current_orbit_osv_precision_review_publication_pending(ROOT, {"promoted": 8}))
        self.assertFalse(current_orbit_osv_precision_review_required(ROOT, {"promoted": 8}))
        self.assertFalse(current_orbit_osv_precision_implementation_publication_pending(ROOT, {"promoted": 8}))
        ...
        self.assertTrue(current_dem_egm2008_proj25_acquisition_pending(ROOT, {"promoted": 8}))
