...
class M2DemActivationTests(unittest.TestCase):
    ...
    def test_milestone_and_profile_preserve_parallel_dem_route(self) -> None:
        ...
        expected_checkpoint = "M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-001-REVIEW" if all_verified else ("M2-DEM-GEOTIFF-VERIFICATION" if all_promoted else "M2-DEM-ACQUISITION")
        ...
        expected_primary_checkpoint = (
            "M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-001-REVIEW"
