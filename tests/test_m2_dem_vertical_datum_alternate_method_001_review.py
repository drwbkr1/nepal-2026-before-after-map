...
class DemVerticalDatumAlternateMethod001ReviewTests(unittest.TestCase):
    ...
    def test_current_controls_preserve_review_and_activate_bounded_implementation(self) -> None:
        ...
        current_checkpoint = "M2-RADAR-PIXEL-ORBIT-APPLICATION-001-REVIEW-PUBLICATION"
        ...
        self.assertEqual(self.profile["control_surfaces"]["proposed_amendments"], ["contracts/milestone-002-radar-pixel-orbit-application-001-proposal.json"])
        self.assertEqual(self.goal["proposed_amendments"], ["contracts/milestone-002-radar-pixel-orbit-application-001-proposal.json"])
