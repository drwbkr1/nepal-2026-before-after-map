...
class OrbitOfflineVerificationRecovery001PostsuccessTests(unittest.TestCase):
    ...
    def test_terminal_state_is_input_only_and_derives_to_dem_vertical_review(self) -> None:
        ...
        self.assertEqual(profile["current_checkpoint"]["checkpoint_id"], "M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW")
        self.assertEqual(goal["current_checkpoint"], "M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW")
        self.assertEqual(
