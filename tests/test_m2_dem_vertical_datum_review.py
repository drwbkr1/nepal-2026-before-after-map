...
class M2DemVerticalDatumReviewTests(unittest.TestCase):
    ...
    def test_historical_control_is_preserved_and_current_state_is_bounded_implementation(self) -> None:
        ...
        current_checkpoint = "M2-DEM-PROJ25-RECEIPT-PERSISTENCE-RECOVERY-002-REVIEW-PUBLICATION"
        ...
        self.assertEqual(units[implementation_checkpoint]["status"], "complete")
        self.assertEqual(units["M2-DEM-EGM2008-PROJ25-ACQUISITION"]["status"], "complete")
        self.assertEqual(
            units["M2-DEM-EGM2008-PROJ25-ACQUISITION"]["disposition"],
            "block_terminal_metadata_representation_mismatch",
        )
        self.assertEqual(
