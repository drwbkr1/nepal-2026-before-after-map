...
**Pending exact owner review:** Recovery proposal SHA-256 `96f0125628e894061fc5da55faff94e92e51b0385293576177c1e15bd009b3da` preserves real-001 and proposes only a code normalization for the existing nested production extent, exact-shape synthetic tests, fresh public CI, a no-pixel preflight, and one new append-only `optical-pixel-readiness-recovery-001` invocation. Review bundle SHA-256 `d137b8ac1d46531ae42e7944955829eb2df37985428431b39863f4a157e83ac2` contains zero human decisions. Radar pixel reads, orbit and DEM actions, baselines, change products, retries, substitutions, and scientific publication remain excluded.
