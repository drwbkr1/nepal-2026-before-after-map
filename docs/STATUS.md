...
The owner approved the exact post-observation label amendment under review bundle SHA-256 `831df5d5aae06862514667ad861c815154085fa3c546039e60f517d38ee442ff` and proposal SHA-256 `ebdcb763afd99ea23090c9bd83fd9e9cb6cb8dfbb2b5fed60edb80f1fa61c731`. The response was locked at SHA-256 `671b296ee45817b20e5244897f0b23b1f2ffd4aa03f73cda104401640cb45358` and reconciled. The new versioned contract has SHA-256 `d02a4344c755ac7b69e2b1bd2b66403fa2a68d204116a32220a03a6e4166e6bd`; it preserves real-001 and changes the expected XML label from `AMPLITUDE` to `Detected`. Three focused tests, all fourteen historical radar tests, and a new ArcGIS Pro 3.7.1 synthetic run pass. Real-002 remains unexecuted until the exact public commit passes CI; even a later pass can establish only partial pre-event header readiness.
