...
## D-078 — Preserve the indeterminate offline-verification attempt and prepare recovery review

**Decision:** Preserve the first `M2-ORB-001` four-source verifier invocation as terminal indeterminate. The verifier read and evaluated the EOF in memory, then failed to persist its receipt because `records/acquisition/orbit-verification` did not exist. Do not infer or reconstruct a pass or fail result, rerun under the consumed attempt, or continue to the other three sources. Prepare a zero-decision review for a post-observation receipt-reservation correction and one separately authorized recovery attempt.

**Reason:** The public-CI, activation, and no-content gates passed, but the final preflight did not verify the receipt parent and the verifier opened the real input before reserving its output. The safe correction is to make durable append-only output reservation a prerequisite for any future EOF content read while leaving every scientific predicate unchanged.

**Status:** Terminal reconciliation SHA-256 `4186ba4f6150f8c1466ab67aa9b22af5222bfadff1e8dcdcd0b619de80449a55` records `verification_output_parent_missing`, one real `M2-ORB-001` evaluation, no durable result, unchanged external custody, and zero reads of `M2-ORB-002` through `004`. Recovery proposal SHA-256 `0be64071cfe718ca758155ff0422cfee48af342c8a560528746adc653e6a2fcf` and review bundle SHA-256 `d2f0f75f40614c56bc0e62c6eecb1588f7504f50927448192673e6e403b5933f` contain zero decisions. No recovery implementation, new EOF read, network or credential action, custody mutation, orbit application, DEM or radar-pixel action, baseline, change analysis, attribution, or scientific publication is authorized before public CI and one exact attested owner decision.

## D-079 — Publish the blank offline-verification recovery review without releasing recovery

**Decision:** Bind the exact zero-decision recovery packet to successful public default-branch CI and advance only to its owner-review gate. Preserve the missing receipt parent and all payload-read prohibitions until an exact attested owner decision is reconciled.

**Reason:** Recovery changes when durable evidence is reserved relative to real EOF access. Public validation of the frozen proposal, review surface, and control reconciliation is required before asking the owner to broaden authority, but publication alone cannot authorize the post-observation correction or another payload read.

**Status:** Exact commit `d4e113911061236c0ff2e7ccd8f1042814d44002` passed GitHub Actions run `34148866971`. Publication-gate SHA-256 `9a2811f96dd191d8b11fa9cbbf78d3769e1a389fd646a5ebd83fc2f134a2f931` and reconciliation SHA-256 `0bca0360730a4a9286e79aa0accf2720f6b3b35e79ff3b6edbc55f37e5c9b0e0` record zero decisions, false attestation, and no recovery authority. The current checkpoint is `M2-ORBIT-OFFLINE-VERIFICATION-RECOVERY-001-REVIEW`. No implementation, new EOF read, network or credential action, external-custody mutation, orbit application, DEM or radar-pixel action, baseline, change analysis, attribution, or scientific publication occurred.

## D-080 — Approve the pre-read receipt-reservation recovery

**Decision:** Bind the owner's exact attested approval of review bundle SHA-256 `d2f0f75f40614c56bc0e62c6eecb1588f7504f50927448192673e6e403b5933f` and proposal SHA-256 `0be64071cfe718ca758155ff0422cfee48af342c8a560528746adc653e6a2fcf`. Release only the exact pre-read receipt reservation and output-parent correction, synthetic persistence, interruption, order, and stop-on-failure tests, public default-branch CI, one final no-content preflight, one new `M2-ORB-001` recovery verification, and only on its pass the three existing fixed-order source attempts.

**Reason:** The first evaluation cannot be reconstructed because it had no durable receipt. Exclusive append-only reservation and fsync before input access makes persistence availability observable before another EOF is read, while preserving the original scientific validation rules and the maximum one-second endpoint rule.

**Status:** Review reconciliation SHA-256 `a07e67160e592093498d44e9ec76f607837f4a7e6b25784458898fa63a8a0fe3`, approval SHA-256 `315812935fe725b5c2928a27abc2b51faf561c423065de6216f975cecbe81f30`, approval activation SHA-256 `ab99cbd6a8af39052a44973161d527a5e22688d6bad79fa5a2713416aecfbfb9`, and approval reconciliation SHA-256 `652b4110d651aeefd43f37ef3a71b61913e65025c4dad420a2ec5c374d60aaf1` bind one approve and true attestation. Candidate contract SHA-256 `8db4774dfb36ce9718988c23d9a480a01028055a6a28a1bbf301a926e466df68` is pending public CI. No EOF content, token, network request, reacquisition, external-custody mutation, second recovery, retry, rule change, orbit application, DEM or radar-pixel action, baseline, change analysis, attribution, or scientific publication has occurred.

## D-081 — Accept four input-only orbit verifications and stop at the DEM vertical review

**Decision:** Record the approved recovery as complete after one new `M2-ORB-001` evaluation and, only on its pass, one existing evaluation each for `M2-ORB-002`, `M2-ORB-003`, and `M2-ORB-004` in fixed order. Preserve the first receipt-less `M2-ORB-001` evaluation as terminal indeterminate. Advance only to the existing `M2-DEM-VERTICAL-DATUM-REVIEW` owner gate.

**Reason:** Pre-read exclusive receipt reservation made persistence availability observable before each EOF content read. All four resulting receipts pass the unchanged identity, checksum, XML, OSV ordering and units, scene-binding, and maximum one-second endpoint rules. These are necessary input controls, but orbit application still depends on an explicit DEM vertical-datum route and separate radar-pixel authority.

**Status:** Implementation commit `72d69e787c772ec2157890bc58a8626e7049dce5` passed public CI run `34153008607`; publication gate SHA-256 `0423dc90781625d16a0d06ae4a101455f8277cbcb1bedde1c95550d7602da920` and final preflight SHA-256 `5dc4a7216c175eca63d6eb4ec9b0b2d082be2b652229b2b0cddbe57e5f0bd6e1` preceded the fixed-order evaluations. Terminal reconciliation SHA-256 `42df98bbe1680483d14aa29dedf55f3761bae4be45991a5a84fbb304b9232182` records four `pass_orbit_input_only` receipts, no retry, zero network requests, unchanged external custody, and no orbit application. Control reconciliation SHA-256 `57ffee10d6703149ae51705f6cd0f21994c97624d29937484fd17e011517ab9b` corrects only the stale four-source projection. No precise-orbit substitution, DEM action, orbit application, radar-pixel decoding, baseline, change analysis, attribution, or scientific publication is released.

## D-082 — Accept the bounded terrain result while retaining the DEM readiness defer

**Decision:** Bind the owner's exact attested approval of terrain-result review bundle SHA-256 `834ad354fc134b2017afdd3b238c1a6271276e8b1a95776e434180c7283a26d5`, proposal SHA-256 `80855c6859a6a78de5712883f604c4f6f7816e459b44638054c3f6a1e848a90c`, and attempt-003 terrain receipt SHA-256 `9663c261de37c77fd96896d1fbb37c4c3a970c47966661908673db880e640dd7`. Treat the gross-artifact, native-seam, AOI-slope, EPSG:32645 projection, stable-output, and rendered-map criteria as accepted only within their reviewed claim boundary. Reassess only the owner `human-review` gate.

**Reason:** The completed response establishes that the owner reviewed and accepted the exact bounded terrain screen. It cannot replace missing vertical-datum evidence, independent elevation accuracy, or pair-specific radar fitness, and it creates no processing or publication authority.

**Status:** The response was locked before reveal at SHA-256 `d075899997fa48d3939aec306d1d2d831c7405fd70771e8280a0afb48924f94f` with receipt SHA-256 `8e82fc01b02a2fcff0df8632530060f8216299c7d9f66161a6cc60f3050b0d80`, then reconciled to one approve, zero revise/defer, and true attestation. A first reassessment input was rejected before decision because an extra provenance field violated the audit schema; the invalid input and failure remain preserved. Corrected reassessment decision SHA-256 `ea11e57faafa79f1e2d6ddaa249b3c01bed91f075364c6f600c6aea2a8a0717a` changes only `human-review` to `pass` and remains `DEFER` on `evaluation-design`, `radar-input-fitness`, and `uncertainty-and-exclusions`, with zero authorized next actions. The checkpoint remains `M2-DEM-VERTICAL-DATUM-REVIEW`. No installation, DEM conversion, orbit application, radar-pixel processing, baseline, change analysis, attribution, derived-pixel publication, or scientific claim is authorized.

## D-083 — Select the exact EGM2008 preconversion method and stop for owner installation

**Decision:** Bind the owner's exact attested approval of vertical-datum review bundle SHA-256 `9b40e81df766ea866c5bff51cdbc4d83e7e7da6a554fb1709fc553d8221bebbc` and proposal SHA-256 `bdaa7f9e10840d41c9bc47d65b33bbee3f71e82fe7862069ff1129785047f065`. Select ArcGIS EGM2008 one-minute preconversion from EPSG:3855 orthometric heights to WGS 84 ellipsoidal heights as the production method, and permit `NONE` only for verified ellipsoidal derivatives. Retain the built-in EGM96 route only as a labeled sensitivity.

**Reason:** The Copernicus DEM height reference is EGM2008, while ArcGIS's SAR `GEOID` switch applies EGM96. Selecting an exact EGM2008 preconversion route prevents either model substitution or use of orthometric source heights as if they were ellipsoidal. The matching `world1x1_vert` component remains absent and must be installed under owner control before the exact grid, transformation, direction, and AOI coverage can be reverified.

**Status:** The response was locked before reveal at SHA-256 `b864b04187d5e4757fd37b475b931123fb88eb4b9b3fca4891f141f600244c2e` with receipt SHA-256 `b4f9b3e80cdf87fd94deef79995df4c5010d507e3849981f39a952cc5ebafdf8`. Reconciliation SHA-256 `c31e8b20f2bc67d3509043ce7f5fcdb501f85f821988dbdb5aa705cb182421e3` records one approve, zero revise/defer, true attestation, and no fabricated decision. Approval SHA-256 `38c872c8dbeeeab08212dd3f71b2dce131b39819c6f7309d1f2b1df2884ee4a6` and control reconciliation SHA-256 `2aa2ef146f0d682d5e0693303fe7d6d00679feb45097af8ac2e85db864829b41` advance only to `M2-DEM-EGM2008-COMPONENT-INSTALL`. No sign-in, terms acceptance, download, installation, UAC action, DEM conversion, source mutation, orbit application, radar-pixel processing, baseline, change analysis, attribution, publication, or scientific claim occurred.

## D-084 — Close the unavailable Esri component path and prepare an open EGM2008 replacement review

**Decision:** Treat the owner's report that Purdue cannot supply ArcGIS Coordinate Systems Data, together with a fresh read-only machine reinspection, as evidence that the approved Esri implementation path is unavailable. Preserve the earlier method approval unchanged, close only its installation dependency as blocked, and prepare a zero-decision review of exact official PROJ-data grid `us_nga_egm08_25.tif` using the already installed ArcGIS GDAL/PROJ runtime.
...
**Status:** Reconciliation SHA-256 `17f63ff5834ce89a500f5cf1408f1bc967a7462e766b86e8f5197205eda5e9d1`, approval SHA-256 `b77d5b943b35efdbc9d8d3c65e1f6122d34f79f581993dc79b244a58fc0a6541`, activation SHA-256 `6d47899d41b057b7ca98696f7f65dbde4a73e8987ffa30aca5800819355a4814`, and readiness SHA-256 `7836bc91e077e43337eee7399e903abd2bf54f7be7314cb7f9eeaa3f850cf9eb` bind the implementation. Exact commit `b37f9da8753a1e6e192f909b76a8097224d49021` passed public CI run `35379385533`; publication-gate SHA-256 is `f1671d8bc577aafcda828f3c90f156a19d480131125f481a4d826fb6096dbe65`. Only the final no-content preflight is released. No real recovery read or conversion has occurred.

## D-087 — Preserve terminal receipt loss after exact promotion and require a new owner decision

**Decision:** Treat metadata recovery-001 as terminal and consumed after it created the exact approved grid destination but failed to persist either a success or failure terminal receipt. Do not retry recovery-001 and do not reconstruct its in-memory validation result. Prepare and publicly validate a zero-decision receipt-persistence recovery-002 packet before any further promoted-grid inspection, operation/sign preflight, or DEM conversion.

**Reason:** ArcGIS `arcpy` rebound the module-level `datetime` class name to the `datetime` module after validation and promotion, so both terminal receipt paths raised `AttributeError`. Read-only reconciliation establishes exact staged and destination size, SHA-256, and same-file identity, but it cannot substitute for the missing durable terminal result.

**Status:** Runtime-failure SHA-256 `98657f032709fca03ce5d4de9790517b6f7fd074e33b0d9d820f10f548f7b373` and outcome-reconciliation SHA-256 `3899e9c788da8dac12328d323bcc104b70b0eb4eddf20127de66c045a5fd51e5` preserve one consumed attempt, zero network requests, the exact 80,585,622-byte grid SHA-256 `4191d471eefebf24091b56dbc604353cb3b8cf8cc70e448bb9ae56a272bef17a`, and zero conversion attempts. Recovery-002 proposal SHA-256 `15180773dd351c9f738e4227ee3faa3ce571f683935f0a229c466bee692b5657` and review bundle SHA-256 `cb4b87ff5c2fcc577bab0f8377524fb7463701a4a3d798fc594b5db4e570f1b5` contain zero human decisions and create no implementation or downstream authority.

## D-088 — Approve the timestamp and pre-read receipt-reservation recovery

**Decision:** Bind the owner's exact attested approval of review bundle SHA-256 `cb4b87ff5c2fcc577bab0f8377524fb7463701a4a3d798fc594b5db4e570f1b5` and proposal SHA-256 `15180773dd351c9f738e4227ee3faa3ce571f683935f0a229c466bee692b5657`. Release only the ArcGIS-safe timestamp correction, synthetic and ArcGIS runtime tests, public default-branch CI, one final no-content preflight, one pre-reserved read-only inspection of the already-promoted exact grid, and conditional unchanged operation/sign and fixed-order conversion actions.

**Reason:** Recovery-001 proved that terminal result construction could fail after the protected read and promotion. A function-local timestamp import prevents ArcGIS name rebinding, while exclusive create, flush, and fsync of the output receipt before grid access makes persistence availability observable without changing any scientific predicate, grid identity, source order, threshold, or tolerance.

**Status:** Locked response SHA-256 `95362b656e8c99c0ee8239d45837cf5033561301a56bc9a80f3dd20d002e0615`, reconciliation SHA-256 `f5b23f4e6ecd3e821e99b2b2e52c482aed4d4a7447ef14861b2936b0c8dfee64`, and approval SHA-256 `862a4e979b1cebaa9d06cc9b350cba91dfec859b081ae89020627a076a34425d` bind the decision. Twenty-one focused portable tests, three ArcGIS runtime tests, and all 545 repository tests with six intentional local skips pass. Commit `5895ba5f4061ad96567264fbcdad8d65eb614dca` failed public CI run `35384885599` because Git normalized two receipt-bound text files from CRLF to LF; original readiness SHA-256 `dd3631709807857b402eb8f773c0763f52fd9b188a83924710cdedf0151639e0` and failure SHA-256 `389aa7ebbfac86da8715adb82ad1ce9d049db3ba6490385de1b7db9855e04ca0` preserve that terminal attempt. Corrected portable readiness SHA-256 `5cbca9f31b3286acba3424a92369b47fad9be81e75988dc7b23a872c7f79764c` passed public CI run `35385405933` at exact commit `8a05517eb5f320921777370024611cf209014672`; publication-gate SHA-256 is `9b52f89eb393364aee605ab998bb57ce2f4f9210b0e1221247e99705ba11d6ef`. Only the final no-content preflight is released, so no promoted-grid read, new promotion, operation/sign preflight, conversion, orbit or radar action, baseline, change analysis, attribution, publication, or scientific claim has occurred.

## D-089 — Accept the exact receipt recovery and fixed-order DEM conversion result

**Decision:** Record the one pre-reserved promoted-grid inspection, unchanged operation/sign preflight, and four exact fixed-order DEM conversion attempts as complete. Preserve every source and attempt, and stop at `M2-ORBIT-APPLY` without executing orbit or radar work.

**Reason:** The terminal receipts establish exact grid identity, `h = H + N`, source immutability, output identity, matching dimensions and geotransforms, finite AOI values, ArcGIS readability, and sub-millimetre seam-correction continuity. These are necessary input controls, but radar pixel readiness and the executable exact-source orbit-application route remain unresolved.

**Status:** Final-preflight SHA-256 `75282ff2681c2778eed3258945c46f64850158dd32c322e4f9fcc4d44b935cc9`, grid-receipt SHA-256 `45eb6d2a243a3c553c6c52c5df5848b384b1f65b9e2512ff6d247b1ed7d29277`, operation-preflight SHA-256 `0e934ece5cb9c948130042484ef3103867a9b611031687d2d2ec760a662423a6`, conversion-batch SHA-256 `d0d57598f204b6a6d42f05f3da48e9b7889acf3d5ec55301a3173b8e30183059`, and terminal reconciliation SHA-256 `2103359e15c4cd963a89d7cdf2169c598c86a0e02e93766e6aab6df3237b30d6` bind the result. Each source was attempted once, all four passed, and no retry, source mutation, network access, new grid promotion, orbit or radar action, baseline, change analysis, attribution, publication, or scientific claim occurred.


## D-090 — Prepare the exact radar pixel readiness and orbit application review

**Decision:** Bind the six exact Sentinel-1 products, four exact verified restituted orbit inputs, four exact ellipsoidal DEM derivatives, two independent radar routes, approved AOIs, installed ArcGIS SAR signatures, and frozen QA rules into one zero-decision owner-review packet. Keep the current readiness decision at `DEFER` until real masked coverage, exclusions, registration, and exact-pipeline reproducibility are measured.

**Reason:** Header readiness, orbit-input verification, and DEM conversion establish necessary input controls but cannot establish usable radar pixels. The frozen pixel-readiness contract requires terrain-corrected masks, AOI coverage, grid checks, seams, and registration, so the next defensible route must govern exact orbit application and QA-only processing together while keeping baseline and change analysis separate.

**Status:** Candidate-manifest SHA-256 `dc4ff8a70c3eb115ee78069afbfd759cc1532fce58de6970584d6b7e5fa34af7`, proposal SHA-256 `3a0f03c5269f4e3e6822c1e31bbe5f19cd288e9e17db67b42990d96b27a4f490`, and review bundle SHA-256 `84af38b7e325e862272b97c9f198dc7a3c3aa2371f4c428e36aaaac6e937f633` contain zero decisions and false attestation. The checkpoint is `M2-RADAR-PIXEL-ORBIT-APPLICATION-001-REVIEW-PUBLICATION`. No implementation, project pixel read, orbit application, processing output, baseline, change product, interpretation, attribution, derived-pixel publication, or scientific claim is authorized before successful public CI and an exact owner decision.

**Publication:** Exact commit `14b796cfc95d9fd77fdc33d56354c949681ef09d` passed public default-branch CI run `35389407797` with 980 required files, 552 tests, and 13 intentional public-runtime skips. The checkpoint is now `M2-RADAR-PIXEL-ORBIT-APPLICATION-001-REVIEW`; only owner review is released, and all processing and scientific restrictions remain in force.

## D-091 — Approve and implement the exact six-source radar QA route

**Decision:** Bind the owner's exact attested approval of review bundle SHA-256 `84af38b7e325e862272b97c9f198dc7a3c3aa2371f4c428e36aaaac6e937f633` and proposal SHA-256 `3a0f03c5269f4e3e6822c1e31bbe5f19cd288e9e17db67b42990d96b27a4f490`. Release only the dependency-ordered implementation, synthetic and installed ArcGIS runtime tests, and public default-branch CI. Keep the final no-content preflight and every real data action blocked until that public gate succeeds.

**Reason:** Exact source, orbit, DEM, route, mask, grid, registration, attempt, and stop-on-failure controls must be executable and publicly reproducible before a single real attempt can consume the approved authority. The installed ArcGIS signatures require explicit output arguments, and production-scale QA requires bounded raster windows rather than full-scene in-memory arrays.

**Status:** Locked reconciliation SHA-256 `cdb32247348c7e065103434c5b788c4d7ea4cf5356d64a5d2d4d5fbd3014dc4e`, approval SHA-256 `1d6522a0a340e3237c29b8489e742c6a8b376314c358ee9ae0d323621cf4b6fe`, and activation SHA-256 `c0b677e14d6c81e4453587eac60c387813e1c02f3203b4bdea9d07f4ea2eca6b` bind one approval and true attestation. The first synthetic fixture failure is preserved; the corrected ArcGIS validation binds the production runner to the installed SAR signatures. Eleven focused tests, one current ArcGIS runtime validation, all 563 repository tests with six intentional skips, and the initial 998-file project checker pass. Initial implementation-readiness SHA-256 is `84d7b4239244aca4608efabf7893a0473088270ba03b38de9b3d9a96321a6ea7`.

**Publication attempt 001:** Exact commit `2d04633a835141084e38bbdc11e1411d48012e95` passed the public checker but failed run `35394937116` on one nonportable test that required the absent Windows external root. Failure SHA-256 is `17ddc940ee4ce021840df56d8278206f9137038d9528842486d62843b2573c96`. Production enforcement is unchanged; only the test now uses metadata-only validation when the external root is absent. The corrected 1,000-file readiness SHA-256 is `5b735e3dc090f0a6d40e6b061bd804fdddc4721f47da9ac8a806937ca67ae039`. The checkpoint remains `M2-RADAR-PIXEL-ORBIT-APPLICATION-001-IMPLEMENTATION`; fresh public CI is pending, and no final preflight or real processing action has occurred.

## D-092 — Record the successful implementation gate and require gate-state publication

**Decision:** Accept corrected implementation commit `ff2e26f5d28d59b02c78f4d16d14ddccb3ff987e` as the public implementation gate for the exact six-source radar QA route, move the control plane to `M2-RADAR-PIXEL-ORBIT-APPLICATION-001-EXECUTION`, and require the exact gate state to pass public default-branch CI before the one final no-content preflight.

**Reason:** The corrected public test is portable without weakening production custody-root enforcement. A second publication boundary keeps the implementation result and the execution release independently inspectable before any project-data content is read.

**Status:** Public CI run `35395320916` passed with 1,000 required files, 563 tests, and 13 intentional public-runtime skips. Implementation publication-gate SHA-256 is `228319332ab4422701d223093429b7a8923b7462838939641d8003ec36c2f1fa`. Gate-state publication remains pending. No final preflight, project-data read, external-custody mutation, real attempt, orbit application, radar pixel processing, route disposition, baseline, change analysis, attribution, derived-pixel publication, or scientific claim has occurred.
**Gate-state publication:** Exact commit `9a8135e5c503b33c29ab25952efcba265c19cd7a` passed public default-branch CI run `35396191631` with 1,003 required files, 563 tests, and 13 intentional public-runtime skips. Gate-state publication SHA-256 is `2da1986b6a4118e75063f5b2a3a6b74c9c6096f758f42cbe546131f50c55bf31`. This releases one final no-content preflight only; real processing remains conditional on its pass, and every scientific restriction remains in force.
## D-093 — Preserve terminal radar real-001 inventory guard failure

**Decision:** Treat `radar-pixel-orbit-application-001-real-001` as terminal and consumed. Preserve the successful no-content preflight, started receipt, read-only identity diagnostic, and terminal reconciliation. Do not retry or reuse this attempt; require a separately reviewed and approved recovery for any inventory-normalization correction and new real attempt.

**Reason:** The runner stopped at the first M1-SRC-001 identity guard before importing ArcGIS or starting source processing. The materialization manifest contains `zip_crc32` and archive order, while `stable_inventory` emits only relative path, size, and SHA-256 in case-insensitive path order. Direct list equality failed even though all 26 normalized, sorted byte identities match.

**Status:** Final-preflight SHA-256 is `55e9a30d22c446596e565d12cf13926a939c90850333d5fca54c1272e3af6662`; diagnostic SHA-256 is `17032e31c285f1d0aa73397c548eed47825510c4f750fc086d10ec17baae5ba4`; terminal-reconciliation SHA-256 is `5696ab1542b386260eff7b3c0591891abe0a907c4c62342e4aa411abd9b73300`. One real attempt and one M1-SRC-001 identity evaluation started; zero source-processing attempts and zero route evaluations started. No retry, source copy, orbit application, radar pixel processing, baseline, change analysis, attribution, derived-pixel publication, or scientific claim occurred.
## D-094 — Prepare strict inventory-normalization recovery-001 review

**Decision:** Publish a zero-decision review proposing only exact inventory normalization and durable terminal-error handling, followed by public implementation CI, one final no-content preflight, and at most one fresh recovery-001 real attempt under the unchanged six-source, two-route contracts. Preserve real-001 as terminal and consumed.

**Reason:** Public validation of terminal commit `05010532745c7dd361a3ee8af34cb8c96a42b95f` confirms the failure evidence. The observed defect is bounded: manifest entries carry `zip_crc32` and archive order, while the runtime inventory uses path, size, and SHA-256 in sorted order. Projecting and sorting both sides preserves strict byte identity while removing only representation differences.

**Status:** Public CI run `35397193358` passed 1,007 required files and 563 tests with 13 intentional skips. Recovery-001 proposal SHA-256 is `cacda42d4eba2d60f3725bf2933fa00ea5ede6f33e6fed4133ca4d3e1476cd04`; review-bundle SHA-256 is `69bae7d7e92f008a4a9a88f0f7408a862c48fe652ea0e98ea022280893a09bc9`; review-readiness SHA-256 is `d091c39f2957743f35d3bdc03e69e3bd4cb5715b061a2301cec8bfe96a4932ec`. The packet has zero decisions and authorizes no implementation, project-data read, new attempt, baseline, change analysis, attribution, publication, or scientific claim.

**Review publication:** Exact commit `8bba9bb3de992f598893214a92fe7ca30c92faae` passed public default-branch CI run `35398189779` with 1,019 required files, 569 tests, and 13 intentional public-runtime skips. Publication-gate SHA-256 is `268c2cb74653ae09936076f7e14bad9ca88e6c421e3fab044301a9b49cdfbc37`. The checkpoint is now `M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-001-REVIEW`; only owner review is released, with zero decisions and no implementation or execution authority.

## D-095 — Approve and implement strict radar inventory normalization

**Decision:** Bind the owner's exact attested approval of review bundle SHA-256 `69bae7d7e92f008a4a9a88f0f7408a862c48fe652ea0e98ea022280893a09bc9` and proposal SHA-256 `cacda42d4eba2d60f3725bf2933fa00ea5ede6f33e6fed4133ca4d3e1476cd04`. Release only strict projection of both inventories to relative path, size, and SHA-256; case-insensitive ordering; durable terminal handling around identity verification; synthetic and installed ArcGIS runtime tests; and public default-branch CI. Keep the final preflight and fresh real attempt blocked until that public gate passes.

**Reason:** Real-001 established that its mismatch was representation-only, but the correction must continue to reject any added or missing path, size or SHA-256 mismatch, duplicate normalized path, unsafe path, or reparse point. Moving the identity check under durable terminal handling ensures every started attempt has a terminal receipt without changing the source, orbit, DEM, route, processing, or scientific contracts.

**Status:** Locked response SHA-256 `3e9603edc2002581c28815a4c1350bd0055eefb2862ad77b0a07cb70cd1b7723`, reconciliation SHA-256 `e6454b84bf76cf07b758e9e075b69b9cfb8a0392b69518a64e7ed16b15cc2554`, approval SHA-256 `4a1fe442f678c354c13f7e255ea459db2ec2d0368c35b72b32170ae8a3dc7d8f`, and activation SHA-256 `1b42eb0f5eb977a7889333eca9ff9f8c25d14116c3baf1cefd51c2a4af94796b` bind the decision. The first synthetic ArcGIS attempt is preserved after a recovery-overlay lookup failure with no project-data or custody access. The corrected second attempt passed in ArcGIS Pro 3.7.1. Nine focused recovery tests, twenty recovery-plus-base regression tests, and all 578 repository tests with six intentional local skips pass. Public CI remains pending; no final preflight, project-data read, new attempt, orbit application, radar-pixel processing, baseline, change analysis, interpretation, attribution, derived-pixel publication, or scientific claim has occurred.

**Publication attempt 001:** Exact commit `cc576817f1c3979871b80563343b96ea60af8ff9` failed public CI run `35404769746` before tests because `EVID-0155` bound the local CRLF readiness bytes while Git normalized that JSON to LF in the public commit. The failed run is terminal and releases nothing. The exact CRLF readiness is preserved separately, the current readiness now has an LF-stable identity, and implementation behavior is unchanged. Fresh public CI remains required before the final preflight or any real action.

**Implementation publication:** Corrected commit `4b35f3a3de1e1f2d2e00d2cf62d4c2164dc59568` passed public default-branch CI run `35405199109` with 1,034 required files, 578 tests, and 13 intentional public-runtime skips. Implementation publication-gate SHA-256 is `1778a9dcb553a5d7eb8473341d62e4dff6e1f4ee387666158461c6916f28312d`. The checkpoint advances to `M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-001-EXECUTION`, but only publication of that exact gate state is released. The final preflight and every real action remain blocked until the gate-state commit passes public CI.

**Gate-state publication:** Exact execution-state commit `e1c57b8c1a56d7fa9a9dc2e7ea732ad215d3773d` passed public default-branch CI run `35405865359` with 1,036 required files, 578 tests, and 13 intentional public-runtime skips. Gate-state publication SHA-256 is `c9d8a120591999af16e093f2eb8763715d54e06e41396b86e4d318dbc247a2e6`. This releases one final no-content preflight; project-data access, the fresh attempt, orbit application, radar-pixel processing, and route evaluation remain conditional on that preflight passing. Baseline, change analysis, interpretation, attribution, derived-pixel publication, and scientific publication remain unauthorized.

**Terminal outcome:** The one final no-content preflight passed at SHA-256 `f2301948835e2d3aac883d4dd14a7e8cf9f3d103ae9bbb6dea6c937387bd3ea2`. The single authorized fresh attempt then completed strict identity verification and terminated during ArcGIS runtime setup with `The Product License has not been initialized.` Terminal reconciliation SHA-256 is `3bd2a4cc6bd56d7ec5ae95a316ff3f5b3cc788b94d32436b3cf02586d7a391c0`; outcome reconciliation SHA-256 is `ef5b7601ce6073c2736297406ac3324f03ca1a84eaa6e7c3dbc35a1a07601d19`. Post-attempt read-only reconciliation confirms all six source inventories, four orbit files, and four DEM derivatives still match. The attempt root contains only start and terminal records: zero source receipts, zero route receipts, zero child directories, and zero derived rasters. Recovery-001 is terminal and consumed; no retry or downstream scientific action is authorized.

## D-096 — Prepare a zero-decision radar delayed-import probe-001 review

**Decision:** Under the owner's review-preparation-only approval, prepare and publish a zero-decision packet proposing one stage-marked delayed-import diagnostic with disposable bytes. Do not implement or execute the probe before a separate exact attested decision on the public packet.

**Reason:** The consumed recovery failed after a 156-file, 10,367,157,634-byte identity scan and before DEM creation, but the exact failing ArcPy statement and historical cause remain unresolved. Current product and extension checks and the earlier disposable raster operation pass. The delayed import after the large scan is the only evidenced sequence difference and remains unproven as causal.

**Status:** Proposal SHA-256 is `7d3474eeed2dd679ca1f755d1ebcf6542b977b87418b40f4b40204ae5ac02de9`; review-bundle SHA-256 is `1084597b5db7b20e24ad241c5550a58623571747d5ef7d37a086298830bd45e5`; review-readiness SHA-256 is `37ce53da206e71ed20db5a4b1b0fef50d3acd953ea9d865de2253a20339ad170`. The packet has zero substantive decisions and releases no implementation, ArcPy invocation, project-data access, recovery action, radar processing, baseline, change analysis, attribution, or scientific publication.

**Review publication:** Exact packet commit `83d94782d255b674843ac4f12cda49327a924fb1` passed public default-branch CI run `35411448542` with 1,058 required files, 584 tests, and 13 intentional public-runtime skips. Publication-gate SHA-256 is `9d514c7cfee958b1c6e8f652486361cb8fe02dbb3b080da2b40022f67853f68b`; publication-reconciliation SHA-256 is `19657eb889bae46e47a53d746b152f1a4574b8b71a5bc9d84b7db6f9a49ea53e`. The checkpoint is now `M2-RADAR-DELAYED-IMPORT-PROBE-001-REVIEW`; only owner review is released.

## D-097 — Approve and implement the disposable delayed-import probe

**Decision:** Bind the owner's exact attested approval of review bundle SHA-256 `1084597b5db7b20e24ad241c5550a58623571747d5ef7d37a086298830bd45e5` and proposal SHA-256 `7d3474eeed2dd679ca1f755d1ebcf6542b977b87418b40f4b40204ae5ac02de9`. Release only the bounded disposable-probe implementation, portable synthetic tests, and public default-branch CI. Keep the final no-content preflight and the one live probe blocked until that public gate passes.

**Reason:** The diagnostic must reproduce only the observed delayed-import sequence, retain durable boundaries around every candidate setup call, and avoid all project and external-custody bytes. A passing or failing probe can describe only the current probe boundary; it cannot establish the historical cause or readiness to retry radar processing.

**Status:** Locked response SHA-256 `7ef5b82aa7c932e8abc3926eb58dc7b7f5221a57bf5ecfced440dc997f57eb82`, reconciliation SHA-256 `aa239f8e78bc23249d270dd0dc30730a8db6c1272f8e730f470105991b478244`, approval SHA-256 `4fcc30884748520cca0c944718e96874092567a8dcf02ec62c9f13c12f2c291e`, and activation SHA-256 `c6f43afc9df68393f084af353e43a4bef991bf5813ec8ad91485f350bad24abf` bind the decision. Eight focused tests and all 593 repository tests pass with six intentional local skips. Exact implementation commit `93b0da073d142105f3efc9425c0cb931fe3f879b` passed public default-branch CI run `35457066264` with 1,073 required files, 593 tests, and 13 intentional public-runtime skips. Implementation-publication-gate SHA-256 is `813ac763286a138b1ee3b87aad3c14a80353fbfdfadbd6169ff7b138d56bb63f`; reconciliation SHA-256 is `653e7648b589c0137d0f0def725c916e765c50e0071f350cd53a4a5d52ffa694`. The current checkpoint is gate-state publication; no final preflight, corpus creation, ArcPy import, live probe, project-data access, recovery action, radar processing, or scientific action has occurred.

**Gate-state publication:** Exact execution-state commit `232982840dbfa3249aaf14267a95a38740f89def` passed public default-branch CI run `35457562260` with 1,076 required files, 593 tests, and 13 intentional public-runtime skips. Gate-state publication SHA-256 is `1ed91c35cdaaf3aa611f6a6f2ab158bc60e420ee3ed7f3321f2b2de621ccd68b`. This releases one final no-content preflight; corpus creation, ArcPy import, and the live probe remain conditional on that preflight passing. Project-data access, external-custody access, recovery reuse or retry, radar processing, baseline, change analysis, interpretation, attribution, derived-pixel publication, and scientific publication remain unauthorized.

**Terminal outcome:** Final no-content preflight SHA-256 `f158d04f11df8181d4145ce1ab35c2b745b5f1d5477267491589a0e97cfdddda` passed. The one authorized live attempt completed exact creation and full stable-order hashing of all 156 disposable files totaling 10,367,157,634 logical bytes. The last durable stage is `arcpy_import_started`. Terminal timestamp construction then escaped with `AttributeError: module 'datetime' has no attribute 'now'`, masking the caught underlying exception and leaving no runner terminal or cleanup receipt. Postprocess cleanup removed the disposable corpus and preserved the original start and stage records. Terminal-reconciliation SHA-256 is `90e7b9ff1fa823f9be805e1fba843e7af9dd34c313d4e5c6c75077c8aee81892`; outcome-reconciliation SHA-256 is `2fe63d80af49baa8a0c92948a3284a4b769fd1c61a10e6b32391a392f0f3cd4c`. Exact terminal commit `2e2763975ffc5e33c17e2cabfa7112a93d25fcbd` passed public CI run `35458643773`; terminal-publication-gate SHA-256 is `44754413056da99d1b228a6f75ee664f3594fa023d55d1dc95f965ad35d9d31a`. Only owner review of the terminal state is released. The attempt is terminal and consumed. It cannot establish whether ArcPy import completed, the original exception, the historical recovery failure cause, or recovery readiness. No follow-on review preparation, project-data or external-custody access, retry, raster, mosaic, radar processing, baseline, change analysis, interpretation, attribution, derived-pixel publication, or scientific publication is authorized.

**Terminal publication:** Exact terminal commit `e83e6b60a6365c8ea305d37e468f986753abb5b7` passed public default-branch CI run `35407396191` with 1,040 required files, 578 tests, and 13 intentional public-runtime skips. Terminal-publication gate SHA-256 is `2d757b464ef71a8f8305145698c2205d4034dc492b51b82fc9261741f3133ade`. This releases only owner review of the terminal state. It does not release recovery-review preparation, implementation, attempt reuse or retry, a new attempt, orbit application, radar pixels, route evaluation, baseline, change analysis, or publication.

**Terminal owner-review observation:** Two read-only launch-path probes currently return `ArcInfo` and successfully check out and return Image Analyst and Spatial. No matching Windows Application event was found in the local failure window. The prior error was therefore not reproduced at the licensing API boundary, but the exact failing ArcPy call and root cause remain unresolved because the consumed attempt retained neither traceback nor stage marker. Observation SHA-256 is `adb9975cb69ef9d68d38f483546af407d99b720fa49b73eedd7d0ba0cf1853e6`. No geoprocessing tool, project-data read, attempt reuse, retry, recovery packet, new authority, or scientific result was created. The owner must separately authorize any no-project-data geoprocessing capability probe or new recovery design.

**Static call-path observation:** The immutable recovery runner places only ArcPy import, `overwriteOutput` assignment, Image Analyst checkout, and Spatial checkout between successful identity verification and `create_dem_mosaic`. That function creates a `dem` child before its first geoprocessing call; the consumed attempt has no child directory. Observation SHA-256 `9ce383af0b813deaf6da84259c7b126e64c8a05610c8ddb01d68fa89a911dd2c` therefore excludes the DEM mosaic, all source processing, orbit application, radar pixels, and route evaluation from the historical failure interval. It does not identify which of the four setup statements failed or resolve why. No runtime probe, project-data read, custody mutation, retry, recovery preparation, or new authority occurred.

**Existing-evidence triangulation:** The approved recovery synthetic ArcGIS receipt demonstrates ArcPy import and generic raster geoprocessing, including `MosaicToNewRaster`, at `2026-09-18T22:50:00Z`, 49 minutes before the real attempt began. The later read-only owner-review observation demonstrates successful product initialization and both extension checkouts 25 minutes after the real attempt began. Triangulation SHA-256 is `de34ea0096017135b7d39995324c6c281d4b61193b2d4f9c317c9b78daa2314a`. These observations do not share one process and do not prove a cause, but they are inconsistent with a persistent installation-wide lack of the ArcGIS product license or both extension entitlements. A transient or process-context-specific failure is plausible but unresolved. No new runtime probe, project-data read, retry, recovery preparation, or authority was created.

**Launch-context comparison:** Sanitized operator-transcript events show the successful synthetic validator, successful final preflight, and failed execute command used the same recorded Codex PowerShell host family, exact ArcGIS Pro Python executable, and repository working directory. Observation SHA-256 is `319c0b21312c185674871470039dfc90c007ee4f85fc31b299da3c33db0e7e93`. The failed execute process uniquely deferred ArcPy import until after hashing the exact 156-file, 10,367,157,634-byte external identity inventory. This excludes a recorded launcher, Python-environment path, or working-directory difference but does not establish that the delay or scan caused the failure; inherited process environment and license-service state were not captured. No new runtime probe, project-data read, retry, recovery preparation, or authority was created.

**Local diagnostic-log review:** A targeted read-only inspection of `%LOCALAPPDATA%\\ESRI`, `%APPDATA%\\ESRI`, and the Windows Application log found no licensing or geoprocessing artifact for `2026-09-18T23:30:00Z` through `2026-09-19T00:10:00Z`. The local ArcToolbox log directory is empty, ArcToolbox history has no entry in the window, and the 33 modified ESRI files are resource-index or map-cache metadata with zero relevant license/error matches. The last ArcToolbox history file is the earlier successful synthetic run. Observation SHA-256 is `c58773641181a8d821426e6fd0d77b33539e6700c478ca1f6295ab5c2d7cf052`. This does not prove that no diagnostic existed elsewhere, but the default local surfaces cannot further resolve the historical cause. No process, project-data read, retry, recovery preparation, or authority was created.

## D-098 — Authorize publication of the delayed-import probe receipt-recovery-001 review

**Decision:** Bind the owner's exact publication-only authorization for review-bundle SHA-256 `df43e0d93f1d40aa85fb1f8730cc57d596fcc4345299b0939b22f822321a9695` and proposal SHA-256 `9bbe934bd1dcbe7d1b0700b83473db2ab1a130c13fa6d183d3b1a247dfe88e09`. Release only bounded repository-control integration, public default-branch publication, public CI, and exact post-CI reconciliation of the unchanged zero-decision packet. Keep the proposal response closed until the exact packet commit passes public CI.

**Reason:** The consumed probe's caught underlying exception was masked when terminal-receipt timestamp construction failed, leaving no runner terminal or cleanup receipt. The packet proposes only a bounded durability correction and one separately gated fresh disposable attempt; it contains zero owner decisions and does not approve that proposal.

**Status:** Publication-approval SHA-256 is `6a8de9f397c6501bf6a1eef560f51c35144ee550fe30dca28c864bc5ca5232eb`; publication-activation SHA-256 is `dc45c9a6b505e05e5720bd2911ef012a24c735fde229f07e61aaf6884588150f`. The checkpoint is `M2-RADAR-DELAYED-IMPORT-PROBE-RECEIPT-RECOVERY-001-REVIEW-PUBLICATION`; public CI is pending. No proposal approval, implementation, ArcPy invocation, corpus creation, new attempt, project-data or external-custody access, radar processing, baseline or change analysis, attribution, or scientific publication is authorized.

**Review publication:** Exact packet commit `872f380fbe8134bcb0c9c76b7fd3952013cfba92` passed public default-branch CI run `35462695951` with 1,098 required files, 600 tests, and 13 intentional public-runtime skips. Publication-gate SHA-256 is `6886334b64e453d64a08226f8f16cae064569fd0d51264baac50d623c9140ad8`; publication-reconciliation SHA-256 is `7ca2e44d1e910982f758be8797f4426d215b14c8e54e2ec099da09e2109781ee`. The checkpoint is now `M2-RADAR-DELAYED-IMPORT-PROBE-RECEIPT-RECOVERY-001-REVIEW`; only owner proposal review is released. The packet remains zero-decision, and every implementation, execution, data-access, radar, analytical, attribution, and publication restriction remains in force.

## D-099 — Approve and implement delayed-import probe receipt recovery-001

**Decision:** Bind the owner's exact attested approval of review-bundle SHA-256 `df43e0d93f1d40aa85fb1f8730cc57d596fcc4345299b0939b22f822321a9695` and proposal SHA-256 `9bbe934bd1dcbe7d1b0700b83473db2ab1a130c13fa6d183d3b1a247dfe88e09`. Release only the function-local timestamp correction, pre-reserved terminal and cleanup identities, append-only fallback error preservation, cleanup independence, portable and installed ArcGIS-runtime synthetic tests, and public implementation CI. Keep final preflight and the one fresh disposable attempt blocked until the public gates pass.

**Reason:** The consumed probe lost its original caught exception when ordinary terminal timestamp construction failed. The recovery must preserve the first sanitized failure before terminal assembly, append any receipt-persistence failure without replacing it, and run cleanup independently. It must not alter the corpus, stage order, geoprocessing sequence, project contracts, or scientific predicates.

**Status:** Locked response SHA-256 is `baf64278ef45352ca7add79948d827fdf87dba8138e722510d89da568a006600`; reconciliation SHA-256 is `77e86a7160a5ed3f8a877a28e6f217f4a759abebe88d5bd056e506110bfc9409`; approval SHA-256 is `cf3781bb8ff4d638f48c4f80a88f0bff24c268b1a6f33e4c5ad2430e691ec4f5`; activation SHA-256 is `afdd859c4fd50f32742db0d27cdd3b404a4bbf1e3d03331add71fd4c497f3753`. Ten focused portable tests and one installed ArcGIS Pro 3.7.1 runtime synthetic test pass. The runtime test confirms timestamp rebinding resilience, original-error retention, append-only terminal-persistence error recording, and cleanup persistence without invoking a geoprocessing tool or reading project or external-custody data. Implementation-readiness SHA-256 is `afc4282244781b0f2e5b6eb27e17f8c3e29e3c0c5eec4c29e50f59fb6e1adbdc`. Public implementation CI is pending. No final preflight, production corpus, fresh attempt, project-data or external-custody access, radar processing, baseline, change analysis, attribution, or scientific publication has occurred.

**Implementation publication:** Exact implementation commit `001fa5f7e23bd3a2348353c947b55adb84da5023` passed public default-branch CI run `35464905883` with 1,117 required files, 610 tests, and 13 intentional public-runtime skips. Only publication and public validation of the exact execution gate state is released. Final preflight, corpus creation, the fresh attempt, data access, radar processing, and every analytical or publication action remain blocked.

**Gate-state publication:** Exact gate-state commit `95686fe7d65333ec1f003982318b3abac7917128` passed public default-branch CI run `35465309836` with 1,119 required files, 610 tests, and 13 intentional public-runtime skips. Gate-state publication SHA-256 is `f8438357a26ecca48605ddff2881d4d95e4346d06ccc79e3436e6b6b443da9d7`. One final no-content preflight is released; the single fresh probe remains conditional on its pass and cannot be retried.

**Terminal result:** Final no-content preflight SHA-256 `121cd502ead7c694c740e2b2abf7b4241c566bbefc8b74d569b54c14a4e5136d` passed. The one fresh attempt completed the exact disposable sequence and cleanup with no retry; terminal-reconciliation SHA-256 is `a942a1827a72462e32caaed7690e785e7bc0c18df04224125a18131eeb09be26` and outcome-reconciliation SHA-256 is `7d7028afdca5b880b2d4d1da69d404db72adf3b5210234cb2a88403c541696b3`. The attempt is consumed. The result is diagnostic only and establishes neither the historical failure's cause nor readiness to rerun radar processing.

**Terminal publication:** Exact terminal commit `64f8b4344ca620c42c1e616409ee57df32d1e6f6` passed public default-branch CI run `35465850755` with 1,123 required files, 610 tests, and 13 intentional public-runtime skips. Terminal-publication-gate SHA-256 is `9a0c430452eac76aed9196ca990398c026e166f3b2ec3abf22dd0bbe8a8e5a42`. Only owner review of the terminal result is released; no follow-on preparation or radar action is authorized.

## D-100 — Authorize publication of the radar pixel and orbit application recovery-002 review

**Decision:** Bind the owner's exact publication-only authorization for review-bundle SHA-256 `e699dfc3c4f7dd5ca697581cf4a299c66128fda7691473d65749681e3dfc211c` and proposal SHA-256 `86366bca8681bbe90dfdd19d6c5b676e490e6dd87c8e04c2900e9fb1df4b29ca`. Release only bounded repository-control integration, public default-branch publication, public CI, and exact post-CI reconciliation of the unchanged zero-decision packet. Keep the proposal response closed until the exact packet commit passes public CI.

**Reason:** Radar recovery-001 is terminal after an unresolved ArcGIS setup failure, while the later disposable delayed-import diagnostic passed at a different host time without proving the historical cause or radar recovery readiness. The packet proposes one separately gated stage-evidenced recovery path while preserving both consumed attempts and every scientific contract.

**Status:** Publication-approval SHA-256 is `634c20297d892adfe702637a5b47624eabef78b5c086d31a744ab4ef21eadf72`; publication-activation SHA-256 is `72be49847d36e63160eed84f7c2acd44db76e56cd2738d911a56ea385b56bd31`. The checkpoint is `M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW-PUBLICATION`; public CI is pending. No proposal approval, implementation, ArcPy invocation, project-data or external-custody access, new attempt, radar processing, baseline or change analysis, attribution, or scientific publication is authorized.

**Review publication:** Exact packet commit `2de376ecd1ed4c226cd5fa2d2e39b763aa5c9438` passed public default-branch CI run `35468801414` with 1,141 required files, 618 tests, and 13 intentional public-runtime skips. Publication-gate SHA-256 is `b1eb5b1ce6f8915477993f61230ca52ad47251839c5dd47f1e61fc4127d66bc6`; publication-reconciliation SHA-256 is `f8e093d9c9eb7db178c7cd9141a46bb0da68f612b80f3c411481ce7c5cf817cf`. The checkpoint is now `M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW`; only owner proposal review is released. The packet remains zero-decision, and every implementation, execution, data-access, radar, analytical, attribution, and publication restriction remains in force.

## D-101 — Approve and implement radar pixel and orbit application recovery-002

**Decision:** Bind the owner's exact attested approval of review-bundle SHA-256 `e699dfc3c4f7dd5ca697581cf4a299c66128fda7691473d65749681e3dfc211c` and proposal SHA-256 `86366bca8681bbe90dfdd19d6c5b676e490e6dd87c8e04c2900e9fb1df4b29ca`. Release only the bounded stage-evidenced recovery wrapper, portable and installed ArcGIS-runtime disposable synthetic tests, and public implementation CI. Keep final preflight, project-data and external-custody access, and the one fresh attempt blocked until both public gates pass.

**Reason:** Both prior attempts are terminal and consumed. Recovery-002 must preserve them, apply the unchanged inventory comparator before delayed ArcPy import, reserve terminal and cleanup evidence before content access, retain the first sanitized failure even if terminal persistence fails, enforce the exact six-source and two-route order, and stop on the first failure without retry or scientific claim.

**Status:** Locked response SHA-256 is `c1c5c613354558815d57a02eb185fc837d94b626d44f958ec2cfb8ca900d14cb`; review reconciliation SHA-256 is `2193aa08750861bc71abec248f1cad7e6b9749b50e2e1debb4eb591c9665d97e`; approval SHA-256 is `d16f3306d582257b32c25911e9f7f50efad935e9599a90e82247d6d813b29d40`; activation SHA-256 is `3d3118db0a7c87781ac3f3c690bb086397abb625e908b1b376fe5d8435fd2e57`. Nine focused tests and all 628 repository tests pass with six intentional local skips. The installed ArcGIS Pro 3.7.1 disposable validation passed both the real ArcPy success path and the forced receipt-failure path; runtime receipt SHA-256 is `5a79867b083c6f26642c40b91710441997b52e480b5ac60870088fcb22b0ccdc`. Implementation-readiness SHA-256 is `c8a8138437040188c2248aa701cb191c84a3fe1704d17d104ce3c7f3c4b4446a`. Public implementation CI is pending. No production attempt, project-data or external-custody content read, production ArcPy invocation, radar processing, baseline, change analysis, interpretation, attribution, derived-pixel publication, or scientific publication has occurred.

**Implementation publication:** Exact implementation commit `8266650829218b7f0db518ff991c9d224b4139dc` passed public default-branch CI run `35470642225` with 1,161 required files, 628 tests, and 13 intentional public-runtime skips. Only publication and public validation of the exact execution-gate state is released. Final preflight, project-data and external-custody access, production ArcPy, the one fresh attempt, radar processing, baseline, change analysis, interpretation, attribution, derived-pixel publication, and scientific publication remain blocked.

**Gate-state publication:** Exact execution-gate commit `52f2e4c8bb84c7c67fd478ee502552b56281cc36` passed public default-branch CI run `35470986919` with 1,163 required files, 628 tests, and 13 intentional public-runtime skips. Gate-state publication SHA-256 is `057d3e09b006e3ad3ddd54b48cb599dba598dd277a26303a0b3335c242b76d3b`. One final no-content preflight is released. Project-data and external-custody access, production ArcPy, and the single fresh attempt remain conditional on its pass; all other excluded actions remain blocked.

**Terminal result:** Final no-content preflight SHA-256 `42e41c84ae9c2a826f185bfaa251a47ffad1f46679b97b6048275e6231a39f01` passed. The one fresh attempt completed every durable setup stage through analysis-support creation, then stopped on the first source. `M1-SRC-001` failed during `ApplyOrbitCorrection` with ArcGIS `ERROR 999999` and “The system cannot locate the object specified.” No later source or route started, no retry occurred, external custody remained unchanged, and cleanup completed. Terminal-reconciliation SHA-256 is `32babf925933b46c88870d5648bb39fd32596bc1b86d1f5fe01c52de84cffdfb`; outcome-reconciliation SHA-256 is `371030851c44810ff2d5d06390c27c76af5b47ee1d8865b8e310025317331339`. The attempt is consumed. The outcome establishes neither historical root cause nor radar recovery readiness and releases no baseline, change analysis, interpretation, attribution, derived-pixel publication, or scientific publication.
