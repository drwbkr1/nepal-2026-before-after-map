...
## Orbit continuation-001 zero-decision review preparation — 2026-09-06

The review bundle utility validates all twelve hash-bound artifacts with no warnings, and an independently generated blank response matches the committed blank response byte-for-byte. The 1800-by-1640 PNG was inspected at original resolution and exposes the current one-promoted/three-unrequested state, fixed source order, one-attempt and stop-on-first-failure policy, prospective maximum one-second endpoint rule, and prohibited scope. Five focused tests pass without importing the optional local renderer. The complete portable suite passes 442 tests with 3 intentional skips, and `scripts/check_project.py` validates 743 required files. Readiness SHA-256 `b8a4534c7a79fb22d5561da375dda220f149d872d2d9ae9432b7fb304248bfb8` records zero decisions, no credential read, no network or payload request, no external mutation, and no scientific result. Public default-branch CI remains required before owner review.

The generic `run-controlled-milestone` validator also ran and returned 42 errors against pre-existing project-specific contract semantics: 25 narrative exit-condition references, 8 custom decision values, and 9 terminal disposition values. Finding SHA-256 `c0846a13c3ba8d3403662142cc1b90cd5b753abb1d4f0f9e792d6031e0db464e` preserves the incompatibility. The continuation packet did not change the then-bound milestone or profile, the project-owned checker and tests passed, and the generic validator mutated nothing. Migrating historical milestone vocabulary remains outside this review-preparation unit.

Exact packet commit `998fb415a04e531c71d4ea49b554168bb99b2095` passed GitHub Actions run `34062485694`. Publication-gate SHA-256 `786fe4ebb5fbf15c357783ea7a58674b98320c25a526a055c74d91ab8c8ad07c` and reconciliation SHA-256 `1b69eb39e6f06224541155209235dac21f36baeffb70194789a2ed71993a60c0` bind that public result and advance only to the blank owner review. The first post-reconciliation full suite preserved seven stale current-checkpoint assertions at SHA-256 `82e8c064f4fc5a1563859e904c561ada7fd37724e345cffedaa221539724b371`; new continuation tests, checkpoint derivation, and the project checker already passed. Only those seven stale expectations changed. The complete suite now passes 446 tests with 3 intentional skips, the project checker validates 748 required files, and checkpoint derivation matches `M2-ORBIT-CONTINUATION-001-REVIEW`.

## Orbit continuation-001 approval and implementation readiness — 2026-09-06

The completed response was locked outside Git at SHA-256 `692f9ef93a7fd43adc76001cc0c6b5fd5dd5738ad840f91bcdb42d446ace0f04`. Aggregate reconciliation SHA-256 `11e29c1e6a259201b745b802f59219234e4bfec2433f1caf909f2202e3b9f0fa` records one approve, zero revise, zero defer, true attestation, and no fabricated decision. Approval SHA-256 `66c40db57082ed29c1dfd3e00a163ab072fe9f14b8e0ed4455df188673de84ba` binds the exact proposal, bundle, review contract, locked response, and receipt. The first lock call used a filename without the required digest suffix and stopped before reading the decision or notes; failure SHA-256 `c8923fbe24cbea7920907ac383bfd86e1511ed87b0eb98c9d9b1b65883daf9fe` retains that event.

The implementation uses the project-owned anonymous single-use in-memory broker, scrubs credential-bearing environment values, launches a detached supervisor, predeclares append-only source evidence, requires fresh byte-zero transfer paths, enforces exact order `M2-ORB-002`, `003`, then `004`, and stops at the first failure. It refuses any `M2-ORB-001` request, redirect, range request, automatic retry, staging collision, or destination replacement. XML and OSV validation retains exact identity, checksum, count, order, finite-value, unit, scene-binding, and maximum one-second endpoint checks.

The initial implementation passed 24 focused tests and the complete 470-test repository suite with three intentional skips. Exact commit `e64acfb566bdd807816744f91fff058384ddf327` passed GitHub Actions run `34065152165`. Publication-attempt SHA-256 `fb5b051daedda020e6a925ae67380ef06fa8b77f07b19b221568f22455501377` then exposed a schema mismatch: the recorder emitted `orbit_payload_request_performed`, while the runtime validator expected `payload_request_performed`. Activation stopped before output creation. Failure SHA-256 `ccc8a18f3ff70b16b6c4a31e5fab262e3a8eccf436082be9ab2230c16a311aa8` records zero final preflight, credential, authentication, payload, handoff, or external mutation. The corrected validator and direct interoperability test pass 25 focused tests and all 471 repository tests; the checker validates 773 required files and read-only derivation remains `M2-ORBIT-CONTINUATION-001-IMPLEMENTATION`. Readiness-002 SHA-256 `707875a46ffccc5793829a3bf66e585d67b712ecf049c080f1520f0e69c799b5` is current. Corrected commit `aec406019e0caf8056352bc675ffd02a487a8b9f` failed GitHub Actions run `34065435604`: the local exact historical activation-failure receipt has SHA-256 `ccc8a18f3ff70b16b6c4a31e5fab262e3a8eccf436082be9ab2230c16a311aa8`, while Git's normalized blob had SHA-256 `98d2a8f35f64f891e44e406ffced4924aaf02dded85b64639d816f96a634ed3d`. Failure record SHA-256 `25546f8192eb8a19ad1c778703e6a00ac7e31ffa1f8f94464e787bacf9fa6ffc` binds that run and records no gate, activation, final preflight, credential, authentication, catalogue, payload, handoff, or external mutation. The original receipt bytes are now non-text Git custody; a fresh public CI run is required before another activation attempt, final no-payload preflight, or owner handoff.

## Orbit continuation-001 completion and four-source verifier readiness — 2026-09-07

Corrected continuation commit `ac19e1bd818e86b94bbd35ecf53fe93863ca91f5` passed GitHub Actions run `34065851960` before activation, final no-payload preflight, and one owner-controlled credential handoff. The fixed-order supervisor made exactly three requests and stopped after all succeeded. `M2-ORB-002` is 631,254 bytes with SHA-256 `7462fa65549339c09c36338cb690d0b953c665c3c61a397def3cfa7b2d453262`; `M2-ORB-003` is 639,533 bytes with SHA-256 `c08bf997f1bf02fb25dcf2a4f35643aef4754fbea03c6c2fb0fa9db4a0efe778`; `M2-ORB-004` is 629,395 bytes with SHA-256 `281388e94a7a8a708f229fd7d19f93de426bb077699db3aaabdad7125043bd83`. Preserved `M2-ORB-001` remains 639,533 bytes with SHA-256 `a72c93e500a1c09b62b4cd31889837c9d57ccc41542b16397ff9f2c0fccba3f4`. Each exact continuation receipt rebinds the provider checksums and promoted identity.

The active four-source verifier remains in `active_gate_pending_continuation_compatibility_public_ci`. Five focused tests validate the exact source order and one-second rules, both authorized receipt forms, duplicate-success rejection, and preactivation real-read refusal. The complete repository suite passes 476 tests with three intentional skips, and `scripts/check_project.py` validates 795 required files and current/historical boundaries. Implementation-readiness SHA-256 `4a3e870929a34558bbdf0415fbdda8c4bd9f67db3315b5956ee0c6a5ac1f97a3` records zero EOF content reads, network requests, credential reads, external mutations, verification receipts, orbit applications, DEM or radar-pixel actions, baselines, change analyses, attributions, or publications. Public default-branch CI is the next gate.

## Four-source verifier terminal persistence failure and recovery review — 2026-09-07

Exact verifier commit `308b6d079696a5f5973f7daa02e137e07a14eea3` passed GitHub Actions run `34145814247`, after which its publication gate, activation, and no-content preflight passed. The first fixed-order invocation then read and evaluated `M2-ORB-001`. Code-path inspection confirmed that `inspect_eof` and the post-read custody inventory execute before `write_new` checks the output parent. Because `records/acquisition/orbit-verification` was absent, receipt persistence stopped with `verification_output_parent_missing`. No durable pass or fail result exists. External orbit custody was unchanged, no automatic retry occurred, and `M2-ORB-002`, `003`, and `004` were not read.

The recovery review bundle utility validated all 13 hash-bound artifacts with no errors or warnings. The 1800-by-1720 PNG was inspected at original resolution and visibly states the post-observation indeterminate result, the proposed pre-read exclusive receipt reservation, unchanged one-second and scientific rules, fixed source order, stop-on-first-failure policy, and prohibited scope. Proposal SHA-256 is `0be64071cfe718ca758155ff0422cfee48af342c8a560528746adc653e6a2fcf`; bundle SHA-256 is `d2f0f75f40614c56bc0e62c6eecb1588f7504f50927448192673e6e403b5933f`; readiness SHA-256 is `8b5f7d0ee2ffe150fa8c0f182e2d0a94c856d7b31252bc50a303e7f3f1aa60eb`. Three focused review tests and the complete 479-test repository suite pass with three intentional skips, checkpoint derivation matches the review-publication gate, and `scripts/check_project.py` validates 813 required files. The blank response has zero decisions and false attestation.

Exact recovery packet commit `d4e113911061236c0ff2e7ccd8f1042814d44002` passed GitHub Actions run `34148866971`. Publication-gate SHA-256 `9a2811f96dd191d8b11fa9cbbf78d3769e1a389fd646a5ebd83fc2f134a2f931` and reconciliation SHA-256 `0bca0360730a4a9286e79aa0accf2720f6b3b35e79ff3b6edbc55f37e5c9b0e0` bind the exact blank packet and advance only to `M2-ORBIT-OFFLINE-VERIFICATION-RECOVERY-001-REVIEW`. The records state zero human decisions, false attestation, no recovery authority, no new EOF read, no network or credential action, no custody mutation, and no downstream scientific action. The missing receipt parent has not been created; recovery implementation remains blocked on one exact attested owner decision.

## Offline-verification recovery-001 approval and implementation gate — 2026-09-07

The owner's exact attested decision on bundle SHA-256 `d2f0f75f40614c56bc0e62c6eecb1588f7504f50927448192673e6e403b5933f` and proposal SHA-256 `0be64071cfe718ca758155ff0422cfee48af342c8a560528746adc653e6a2fcf` was locked before semantic reconciliation. Review reconciliation SHA-256 `a07e67160e592093498d44e9ec76f607837f4a7e6b25784458898fa63a8a0fe3`, approval SHA-256 `315812935fe725b5c2928a27abc2b51faf561c423065de6216f975cecbe81f30`, activation SHA-256 `ab99cbd6a8af39052a44973161d527a5e22688d6bad79fa5a2713416aecfbfb9`, and approval-reconciliation SHA-256 `652b4110d651aeefd43f37ef3a71b61913e65025c4dad420a2ec5c374d60aaf1` bind one approve, zero revise/defer, and true attestation.

Candidate contract SHA-256 `8db4774dfb36ce9718988c23d9a480a01028055a6a28a1bbf301a926e466df68` preserves all four exact source identities and the maximum one-second endpoint rule. The implementation creates only the tracked output-parent marker, reserves each exact append-only receipt with exclusive creation and fsync before EOF inventory or inspection, writes through the reserved handle, preserves empty or partial interruption evidence, refuses path reuse, enforces fixed order, and stops on the first failure. Nine focused recovery tests and the complete 489-test repository suite pass with three intentional skips; the checker validates 833 required files after sealing readiness SHA-256 `1edbb5db3e900cc947886c9672b080f2e2bc87ad48151b95c82edde3863286b1`. Public default-branch CI and a subsequent final no-content preflight remain required before the one authorized recovery read. No token, network request, reacquisition, custody mutation, orbit application, DEM or radar-pixel action, baseline, change analysis, attribution, or scientific publication has occurred.

## Offline-verification recovery-001 terminal input pass — 2026-09-07

Implementation commit `72d69e787c772ec2157890bc58a8626e7049dce5` passed public GitHub Actions run `34153008607`. Publication-gate SHA-256 `0423dc90781625d16a0d06ae4a101455f8277cbcb1bedde1c95550d7602da920`, activation SHA-256 `8c11f226be1632b5d6df86f3cc3de63524cb62095d1cb173abe2fe8fbc396ccf`, and final no-content preflight SHA-256 `5dc4a7216c175eca63d6eb4ec9b0b2d082be2b652229b2b0cddbe57e5f0bd6e1` preceded all four authorized evaluations.

The new `M2-ORB-001` recovery evaluation passed and persisted receipt SHA-256 `eaf9344737bcd81598dbfb78b0e580156224860b113ae47914f1a4b101a910d5`. Its pass released the three existing attempts, which ran once each in fixed order and persisted receipt SHA-256 values `13e4b612edebfd6a101c31cc98887a78181b1322cf9213d3e910c21d57453a7e`, `47b7ad088b8a419eb2ec69b0997e2d5260f698d8865fcac7f05860a43b1bbd18`, and `f6d0ffb08d42499c5ae7fdba46755d10898dff29c5dc74349d35738fc0d41718`. Each receipt is `pass_orbit_input_only`, binds its promoted checksum and structural/XML/OSV/scene predicates, preserves the maximum one-second endpoint rule, and records unchanged custody. No retry, network request, credential action, reacquisition, or external-custody mutation occurred.

Terminal reconciliation SHA-256 `42df98bbe1680483d14aa29dedf55f3761bae4be45991a5a84fbb304b9232182` advances only to `M2-DEM-VERTICAL-DATUM-REVIEW`. A read-only post-success comparison found one stale current projection listing only the originally indeterminate source; reconciliation SHA-256 `57ffee10d6703149ae51705f6cd0f21994c97624d29937484fd17e011517ab9b` corrected that field to the exact four-source order while preserving `M2-ORB-001` as the initial indeterminate source. It read no EOF content and changed no external data.

This validation establishes orbit-file identity and input structure only. It does not establish precise-orbit equivalence, geolocation accuracy, registration, DEM vertical compatibility, radar-pixel readiness, a baseline, change, attribution, or a scientific result. Orbit application has not started.

## DEM vertical-datum method approval and owner-install stop — 2026-09-07

The owner's exact attested decision on review bundle SHA-256 `9b40e81df766ea866c5bff51cdbc4d83e7e7da6a554fb1709fc553d8221bebbc` and proposal SHA-256 `bdaa7f9e10840d41c9bc47d65b33bbee3f71e82fe7862069ff1129785047f065` was locked outside Git before semantic reconciliation. The private response has SHA-256 `b864b04187d5e4757fd37b475b931123fb88eb4b9b3fca4891f141f600244c2e`; its lock receipt has SHA-256 `b4f9b3e80cdf87fd94deef79995df4c5010d507e3849981f39a952cc5ebafdf8`. Public review reconciliation SHA-256 `c31e8b20f2bc67d3509043ce7f5fcdb501f85f821988dbdb5aa705cb182421e3`, approval SHA-256 `38c872c8dbeeeab08212dd3f71b2dce131b39819c6f7309d1f2b1df2884ee4a6`, and control reconciliation SHA-256 `2aa2ef146f0d682d5e0693303fe7d6d00679feb45097af8ac2e85db864829b41` bind one approve, zero revise/defer, and true attestation.

The selected production route is exact ArcGIS EGM2008 one-minute preconversion: interpret the source DEM as EGM2008 orthometric height in EPSG:3855, use `WGS_1984_To_WGS_1984_EGM2008_1x1_Height` (WKID 110018) with `Dataset_egm2008-1.grd`, and preserve EPSG:4326 horizontally while creating a new WGS 84 ellipsoidal derivative. The source DEM cannot be overwritten. The matching ArcGIS Coordinate Systems Data component and `world1x1_vert` feature remain owner-installed prerequisites; neither the component nor grid is presently verified.

The first complete postapproval suite ran 499 tests and preserved 13 stale current-checkpoint failures with three intentional skips at SHA-256 `eba1fdc663e99118d5304cf12ba49d9c3d2b787273e5b3eb053bfc0d4cc520a2`. Checkpoint derivation and only the affected current-state assertions were corrected without changing the owner decision or historical terminal evidence. Validation SHA-256 `8986899b06d82e26208c8a4b31815994112ca51595fce09649c0b2d86d15bbc4` records the corrected 499-test pass with three intentional skips. The project checker validates 860 required files and derives `M2-DEM-EGM2008-COMPONENT-INSTALL` with no tracked mutation.

Initial publication commit `6437c2c05b98ec70922b12d5a6f9396062196aad` failed GitHub Actions run `34161358203` in repository validation before the test step. Three EVID-0124 control hashes had been calculated from CRLF working-tree bytes, while Git correctly published canonical LF bytes under `.gitattributes`; the Linux checker therefore stopped on the byte mismatch. Failure record SHA-256 `44744391a120422ad0a130054b0ef82a060f035de4d2645f51e6732603b3a878` preserves the run. The three bindings now use repository-LF bytes, with no production, decision, data, or scientific logic change.

Corrected commit `6a78e3232a290f1b799f1459066f2420439af67f` passed GitHub Actions run `34161674667`. The public run validated 860 required files and passed all 499 tests with ten environment-dependent skips. Publication-gate SHA-256 `8e106fede95cee3e9087e27c45f50d99f78e8132b1b465c713ea6e89add46bb9` records the successful default-branch result and leaves the checkpoint at the owner-controlled component installation.

No My Esri sign-in, terms acceptance, download, installation, UAC action, DEM conversion, alternate-grid substitution, orbit application, radar-pixel access, baseline, change analysis, attribution, derived-pixel publication, or scientific result was performed or released.

### Alternate EGM2008 method review preparation

The owner reports that Purdue cannot supply the optional ArcGIS Coordinate Systems Data component. A fresh read-only reinspection at `2026-09-18T01:22:28Z` again found ArcGIS Pro 3.7.1 Advanced, the built-in EGM96 grid, no `Dataset_egm2008-1.grd`, no `Dataset_egm2008-25.grd`, and no usable exact EGM2008 transformation. Receipt SHA-256 `732c0c53b90c1cfc71b5a804e04bb90270be627457b1c4a08d8c1289bd9c3d83` identifies the ignored scratch inspection; tracked access-closure SHA-256 is `4fc0d59d9da19ed5d97bfd85fa17bf485db9ad84df5dd125339eb7e78d3e7ffd`.

Official PROJ-data metadata binds `us_nga_egm08_25.tif` to worldwide WGS84 ellipsoidal-to-EGM2008 height semantics, exact size 80,585,622 bytes, exact SHA-256 `4191d471eefebf24091b56dbc604353cb3b8cf8cc70e448bb9ae56a272bef17a`, NGA provenance, and public-domain status. The installed ArcGIS Python runtime reports GDAL 3.12.2e, PROJ 9.8.1, EPSG:3855/4979/9518 support, and PROJ network access disabled. GeographicLib's published conservative EGM2008 2.5 arc minute bilinear interpolation error is 0.135 m maximum and 0.0032 m RMS relative to the model. These facts establish review readiness only.

The review packet binds proposal SHA-256 `dd920e205cb34f812dbbed422909acd9d3357d2f7b53f6843eccf03259e226d7`, bundle SHA-256 `caa27cad02aa78caeb38c511ea3cae7ebb637833bd4d54881b8a557a38eb1702`, and contract SHA-256 `306eb3fa56ba0feb58818947b5f2dcac7cc8c9ac9ebcade47adb3bc08132e8e1`. Its response is blank. The recommended grid payload has not been requested. The quarantined GeographicLib partial from the redirect incident cannot be treated as a grid, resumed, reused, or retried. No conversion or radar action is released before exact owner approval, implementation tests, public CI, and the proposal's final no-payload gate.

Local validation preserved the first full-suite result: 506 tests ran with six failures because checkpoint derivation and historical control tests still expected the now-closed Esri component-install state or no pending amendment. After separating historical approval evidence from current control state and deriving the exact alternate-method owner-review checkpoint, the same 506-test suite passed with zero failures and three intentional skips. A final run after adding the durable validation assertion passed 507 tests with three intentional skips. The review remains zero-decision and released no grid acquisition, DEM pixel read, or conversion.

Exact packet commit `847501b227de4d258309c5909e5333bd8e824947` passed public GitHub Actions run `35297712043`. The public run validated 875 required files and passed all 507 tests with ten environment-dependent skips. The publication receipt preserves zero decisions and advances only to the exact alternate-method owner review.

## PROJ25 metadata recovery implementation validation — 2026-09-18

The owner response was locked before semantic reconciliation. The locked response SHA-256 is `97dc8475b9b7a6892a79a1f0d519bbc32e87bea91346f5f1dec0d07432e0a1ee`; lock receipt SHA-256 is `c1a1403fe574130588aea1ba892571fd5cde8c8a7f7d35ebe22548135cf9fccd`. Public reconciliation and approval records bind the exact proposal and bundle without fabricating decisions.

Focused portable validation ran 21 tests with zero failures or skips. Installed ArcGIS Pro Python validation ran two synthetic tests with zero failures: one sparse 8640-by-4321 GeoTIFF expressed the exact official metadata representation and passed both GDAL inspection and ArcGIS readability; one inverse-grid conversion retained the approved `h = H + N` sign, finite output, ArcGIS readability, and source immutability. The complete repository suite ran 531 tests with zero failures and five intentional environment-dependent skips. `scripts/check_project.py` validates 918 required files, current authority, exact hashes, immutable historical evidence, and the no-network/no-payload release boundary.

Implementation-readiness SHA-256 `7836bc91e077e43337eee7399e903abd2bf54f7be7314cb7f9eeaa3f850cf9eb` records zero network requests, preserved-grid reads, promotions, real DEM pixel reads, external-data mutations, conversions, orbit or radar actions, baselines, change analyses, or scientific results. Exact commit `b37f9da8753a1e6e192f909b76a8097224d49021` passed public run `35379385533`, which validated 918 required files and ran 531 tests with 12 intentional skips. Publication-gate SHA-256 `f1671d8bc577aafcda828f3c90f156a19d480131125f481a4d826fb6096dbe65` releases only the final no-content preflight; no preserved-grid byte has been read under recovery authority.

## PROJ25 terminal receipt failure and recovery-002 review readiness — 2026-09-18

The authorized final no-content preflight passed before any grid content read. Metadata recovery-001 then recorded its durable started event, verified the exact staged file, and created the destination as a no-replace hard link. After ArcGIS imported `arcpy`, the module-level `datetime` class binding changed to the `datetime` module. Terminal receipt construction therefore failed with `AttributeError: module 'datetime' has no attribute 'now'`; the failure-receipt path hit the same error. Recovery-001 is terminal, its single attempt is consumed, and no retry occurred.

Read-only reconciliation found the staged and destination paths at exactly 80,585,622 bytes with SHA-256 `4191d471eefebf24091b56dbc604353cb3b8cf8cc70e448bb9ae56a272bef17a` and the same file identity. No public or external terminal receipt exists, no network request occurred, and no operation/sign preflight or DEM conversion started. The missing in-memory result was not reconstructed.
