...
Sentinel-1 orbit correction has a third independent human gate at `M2-ORBIT-AMENDMENT-REVIEW`. Review bundle SHA-256 `ee5fbf4933b52be8f97441b78a73559a973bd975efc21b43625f1ceca54e2ff1` binds proposal SHA-256 `b17e256068759946be611bf4e7beffe0d3121e9e731b6c42163525eca2cf0292`, four exact S1D `AUX_RESORB` files, six exact Sentinel source bindings, official live metadata, and non-active intake and verification controls; it contains zero human decisions. Do not download, parse, store, or apply an orbit file until this exact bundle is approved, locked, and reconciled. Do not silently substitute a later `AUX_POEORB` file: precise-orbit selection requires a fresh exact manifest and review. The DEM vertical-datum and terrain-result gates, Sentinel custody, pixel readiness, radar processing, and scientific claims remain separate.
