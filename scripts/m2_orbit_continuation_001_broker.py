#!/usr/bin/env python3
"""Receive one CDSE token and hand it to the detached orbit continuation supervisor."""
...
def main() -> int:
    ...
    try:
        ...
        secret = ""
        print(json.dumps({
            "status": "secret_handed_to_detached_orbit_continuation_supervisor",
        ...
        return 0
    except OrbitContinuation001Error as exc:
        handoff_claimed = handoff_claimed or (DATA_ROOT / "derived/m2-orbit-continuation-001-handoff").exists()
        print(json.dumps({
            "status": "stopped",
            "code": exc.code,
            "credential_value_recorded": False,
        ...
        print(json.dumps({
            "status": "stopped",
            "code": "orbit_continuation_001_broker_unexpected_failure",
            "credential_value_recorded": False,
            "owner_handoff_claimed": handoff_claimed,
            "authority_consumed": handoff_claimed,
        }, indent=2))
