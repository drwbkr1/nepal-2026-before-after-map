#!/usr/bin/env python3
"""Portable decisions for the amended read-only Sentinel-1 SAFE readiness gate."""
...
def validate_contract(contract: dict[str, Any]) -> list[str]:
    errors: list[str] = []
    if contract.get("contract_id") != "NEPAL-S1-MATERIALIZED-INPUT-READINESS-002":
        errors.append("contract identity differs")
    if contract.get("status") != "active_amendment_001_exact_three_pre_event_sources":
