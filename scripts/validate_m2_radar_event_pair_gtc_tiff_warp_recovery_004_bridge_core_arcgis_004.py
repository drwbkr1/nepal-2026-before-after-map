#!/usr/bin/env python3
"""Distinct disposable-004 test of the actual recovery-004 bridge function."""
...
SCRATCH = ROOT / "scratch/m2-radar-event-area-pair-gtc-tiff-warp-recovery-004-disposable-004"
RECEIPT = ROOT / "records/readiness/m2-radar-event-area-pair-gtc-tiff-warp-recovery-004-arcgis-disposable-004.json"
...
def run() -> dict:
    ...
    if SCRATCH.exists() or RECEIPT.exists():
        raise RuntimeError("append_only_disposable_004_collision")
