#!/usr/bin/env python3
"""Run synthetic ArcGIS checks for the radar inventory-normalization recovery."""
...
from m2_radar_pixel_orbit_application_recovery_001_core import validate_recovery_contract
...
RECOVERY_RUNNER_REF = "scripts/run_m2_radar_pixel_orbit_application_recovery_001.py"
...
def main() -> int:
    ...
    base_contract_path = ROOT / BASE_CONTRACT_REF
    ...
    errors = validate_recovery_contract(contract, ROOT)
    errors.extend(f"base: {item}" for item in validate_base_contract(base_contract, ROOT))
    if errors:
    ...
    registration = measure_stable_registration(
        ...
        exclusion_bboxes=[],
        settings=base_contract["registration"],
    ...
    receipt = {
        "schema_version": "1.0",
        "receipt_id": "NEPAL-M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-001-SYNTHETIC-ARCGIS",
        ...
        "bindings": {
            ...
            "recovery_core_ref": "scripts/m2_radar_pixel_orbit_application_recovery_001_core.py",
            "recovery_core_sha256": sha256(ROOT / "scripts/m2_radar_pixel_orbit_application_recovery_001_core.py"),
            "base_core_ref": "scripts/m2_radar_pixel_orbit_application_001_core.py",
            "base_core_sha256": sha256(ROOT / "scripts/m2_radar_pixel_orbit_application_001_core.py"),
            "adapter_ref": "scripts/validate_m2_radar_pixel_orbit_application_recovery_001_arcgis.py",
            "adapter_sha256": sha256(Path(__file__).resolve()),
            "recovery_runner_ref": RECOVERY_RUNNER_REF,
            "recovery_runner_sha256": sha256(ROOT / RECOVERY_RUNNER_REF),
            "base_production_runner_ref": RUNNER_REF,
            "base_production_runner_sha256": sha256(ROOT / RUNNER_REF),
        },
        "checks": {
        ...
        "assertions": {
            ...
            "base_production_runner_calls_match_installed_signatures": True,
            "recovery_runner_delegates_unchanged_sar_processing": True,
