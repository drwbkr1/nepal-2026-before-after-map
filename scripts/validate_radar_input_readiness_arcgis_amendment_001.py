#!/usr/bin/env python3
"""Validate the amended Sentinel-1 input-readiness rules with synthetic ArcGIS TIFFs."""
...
from inspect_radar_inputs_arcgis_amendment_001 import describe_raster
...
def main() -> int:
    ...
    receipt = {
        "receipt_version": "1.0",
        "receipt_id": "NEPAL-S1-MATERIALIZED-INPUT-READINESS-SYNTHETIC-AMENDMENT-001",
        ...
        "bindings": {
            ...
            "core_sha256": digest("scripts/radar_input_readiness_core_amendment_001.py"),
            "runner_ref": "scripts/inspect_radar_inputs_arcgis_amendment_001.py",
            "runner_sha256": digest("scripts/inspect_radar_inputs_arcgis_amendment_001.py"),
            "adapter_ref": "scripts/validate_radar_input_readiness_arcgis_amendment_001.py",
            "adapter_sha256": digest("scripts/validate_radar_input_readiness_arcgis_amendment_001.py"),
        },
        "runtime": {
        ...
        "next_action": "Publish this amended gate and require successful public CI before the one authorized real-002 inspection.",
    }
