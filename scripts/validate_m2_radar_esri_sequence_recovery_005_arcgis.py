#!/usr/bin/env python3
"""Validate seven ArcPy interfaces for recovery-005 without invoking a raster function."""
...
OUTPUT_REF = "records/readiness/m2-radar-esri-sequence-recovery-005-arcgis-runtime-validation.json"
EXPECTED_PARAMETERS = {
...
RASTER_RETURNING = {
    ...
    "Despeckle", "ApplyGeometricTerrainCorrection", "ConvertSARUnits",
}
...
def main() -> int:
    ...
    receipt = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-ESRI-SEQUENCE-RECOVERY-005-ARCGIS-RUNTIME-VALIDATION",
        "status": "pass_installed_arcgis_runtime_seven_interface_signature_only_validation",
        ...
        "method_amendment": {
            "exact_despeckle_call_shape": ["in_radar_data", "VV;VH", "REFINED_LEE"],
            "filter_size_argument_omitted": True,
            "position": "after_rtf_before_gamma_gtc",
        },
        "assertions": {
