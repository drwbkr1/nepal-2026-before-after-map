#!/usr/bin/env python3
"""Record successful public CI for the receipt-recovery implementation."""
...
from m2_radar_delayed_import_probe_receipt_recovery_001_core import canonical_bytes, sha256_file, write_new_json
...
NEXT_ACTION = (
    "Publish and publicly validate the exact receipt-recovery implementation-gate state. Do not run the final no-content "
    "preflight or create the production corpus or fresh probe until that gate-state commit passes public CI."
)
...
def main() -> int:
    ...
    gate = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-DELAYED-IMPORT-PROBE-RECEIPT-RECOVERY-001-IMPLEMENTATION-PUBLICATION-GATE",
    ...
    reconciliation = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-DELAYED-IMPORT-PROBE-RECEIPT-RECOVERY-001-IMPLEMENTATION-PUBLICATION-RECONCILIATION",
        "recorded_at_utc": args.recorded_at_utc,
        ...
        "implementation_commit_sha": args.implementation_commit_sha,
        "public_ci_run_id": args.public_ci_run_id,
        "released_now": {"gate_state_publication": True, "final_no_content_preflight": False, "fresh_probe": False},
        "next_action": NEXT_ACTION,
    }
    ...
    implementation["exit_condition_delta"] = {
        "expected": [],
        "observed": ["exact receipt-recovery implementation passed public default-branch CI"],
        "decision_value": "enables_dependency",
        "rationale": "Only publication of the exact gate state is released now; final preflight remains blocked.",
    }
    ...
    evidence = {
        "record_id": "EVID-0177",
        "type": "m2_radar_delayed_import_probe_receipt_recovery_001_implementation_publication_gate",
        "verified_at_utc": args.recorded_at_utc,
        "status": "pass_public_ci_gate_state_publication_pending",
        "claim": "The exact receipt-recovery implementation commit passed public default-branch CI. Only gate-state publication is released; final preflight and the fresh probe remain blocked.",
        "implementation_publication_gate_ref": GATE_REF,
        "implementation_publication_gate_sha256": sha256_file(ROOT / GATE_REF),
