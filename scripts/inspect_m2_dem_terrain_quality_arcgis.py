#!/usr/bin/env python3
"""Run the predeclared read-only DEM terrain-quality inspection in ArcGIS Pro."""
...
def main() -> None:
    ...
    write_new_json(manifest_path, {"schema_version": "1.0", "created_at_utc": args.executed_at_utc, "files": output_inventory})
