#!/usr/bin/env python3
"""Record successful public CI for the exact M2-ORB-001 recovery-003 implementation."""
...
OUTPUT = ROOT / "records/acquisition/m2-orbit-recovery-003-publication-gate.json"
FILES = {
    ...
    "approval_activation_script_sha256": ROOT / "scripts/activate_m2_orbit_recovery_003_approval.py",
    ...
    "implementation_readiness_sha256": ROOT / "records/acquisition/m2-orbit-recovery-003-implementation-readiness.json",
    "implementation_readiness_recorder_sha256": ROOT / "scripts/record_m2_orbit_recovery_003_implementation_readiness.py",
}
...
def main() -> int:
    ...
    payload = {
        "schema_version": "1.0",
        "receipt_id": "NEPAL-M2-ORBIT-RECOVERY-003-PUBLICATION-GATE-001",
        "verified_at_utc": args.verified_at_utc,
        "status": "pass_public_controls_verified_before_orbit_recovery_003",
        ...
        "next_gate": "reconcile approved controls, activate recovery-003, and pass the final no-payload preflight before owner credential entry",
    }
