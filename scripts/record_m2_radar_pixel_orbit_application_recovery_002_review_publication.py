#!/usr/bin/env python3
"""Record public CI and open owner review for the exact radar recovery-002 packet."""
...
PUBLICATION_CHECKPOINT = "M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW-PUBLICATION"
...
NEXT_ACTION = (
    "Review the exact public M2 radar pixel and orbit application recovery-002 bundle and proposal; approve, "
    "revise, or defer the bounded stage-evidence and one-fresh-attempt proposal. No implementation, ArcPy "
    "invocation, project-data or external-custody access, new attempt, radar processing, baseline or change "
...
def main() -> int:
    ...
    if (args.required_file_count, args.public_test_count, args.public_skip_count) != (1141, 618, 13):
    ...
    if not isinstance(review, dict):
        raise SystemExit("radar recovery-002 review unit missing")
    if (
        ...
        or review.get("gates", {}).get("new_attempt_authorized") is not False
    ...
    gate = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW-PUBLICATION-GATE",
    ...
    reconciliation = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-PIXEL-ORBIT-APPLICATION-RECOVERY-002-REVIEW-PUBLICATION-RECONCILIATION",
    ...
    evidence = {
        "record_id": "EVID-0182",
        "type": "m2_radar_pixel_orbit_application_recovery_002_review_publication_gate",
        "verified_at_utc": args.verified_at_utc,
        "status": "pass_public_ci_zero_decision_owner_review_ready",
        "claim": "The exact blank radar pixel and orbit application recovery-002 packet passed public default-branch CI. Only owner proposal review is released; no implementation, ArcPy, new attempt, project-data or external-custody access, radar processing, baseline, change analysis, attribution, or scientific publication occurred.",
        "publication_gate_sha256": sha256(GATE_REF),
        "publication_reconciliation_sha256": sha256(RECONCILIATION_REF),
        "proposal_sha256": PROPOSAL_SHA256,
        "review_bundle_sha256": BUNDLE_SHA256,
