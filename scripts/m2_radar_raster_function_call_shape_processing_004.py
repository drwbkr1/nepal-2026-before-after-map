#!/usr/bin/env python3
"""Recovery-004 processing functions with exact Raster-returning ArcPy call shapes."""
    ...
    *,
    ...
    with arcpy.EnvManager(
        ...
        _save_raster_result(
            ...
            arguments=(str(outputs["gamma_slant"]), "VV;VH", str(dem_mosaic), "NONE"),
...
def process_source(
    *,
    ...
    receipt_namespace = plan.get("contract", {}).get(
        "receipt_namespace", "RADAR-RASTER-FUNCTION-CALL-SHAPE-RECOVERY-004"
    )
    write_new_json(
        started_path,
        {
