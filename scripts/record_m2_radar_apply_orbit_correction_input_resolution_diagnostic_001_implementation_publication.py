#!/usr/bin/env python3
"""Record successful public CI for the read-only diagnostic implementation."""
...
from run_m2_radar_apply_orbit_correction_input_resolution_diagnostic_001 import repository_bindings
...
CHECKPOINT = "M2-RADAR-APPLY-ORBIT-CORRECTION-INPUT-RESOLUTION-DIAGNOSTIC-001-EXECUTION"
NEXT_ACTION = (
    "Publish and publicly validate the exact diagnostic implementation-gate state. Do not run the final no-content "
    "preflight, import production ArcPy, or access the recovery-002 attempt root or orbit custody until that gate-state commit passes public CI."
)
...
def main() -> int:
    ...
    gate = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-APPLY-ORBIT-CORRECTION-INPUT-RESOLUTION-DIAGNOSTIC-001-IMPLEMENTATION-PUBLICATION-GATE",
        "recorded_at_utc": args.recorded_at_utc,
        "status": "pass_public_default_branch_ci_read_only_diagnostic_implementation_ready",
    ...
    reconciliation = {
        "schema_version": "1.0",
        "record_id": "NEPAL-M2-RADAR-APPLY-ORBIT-CORRECTION-INPUT-RESOLUTION-DIAGNOSTIC-001-IMPLEMENTATION-PUBLICATION-RECONCILIATION",
        "recorded_at_utc": args.recorded_at_utc,
        ...
        "implementation_commit_sha": args.implementation_commit_sha,
        "public_ci_run_id": args.public_ci_run_id,
        "released_now": {"gate_state_publication": True, "final_no_content_preflight": False, "diagnostic_process": False},
        "next_action": NEXT_ACTION,
    }
    ...
    implementation["exit_condition_delta"] = {
        ...
        "rationale": "Only publication of the exact execution-gate state is released; final preflight and diagnostic access remain blocked.",
    }
    ...
    evidence = {
        ...
        "claim": "The exact read-only diagnostic implementation passed public default-branch CI. Only publication of its gate state is released; no final preflight or external input access occurred.",
        "implementation_publication_gate_ref": GATE_REF,
        "implementation_publication_gate_sha256": sha256_file(ROOT / GATE_REF),
