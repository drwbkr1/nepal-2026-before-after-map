...
def main() -> None:
    ...
    gdal.UseExceptions()
    contract = load("config/qa/optical-input-readiness-contract.json")
    ...
    script_ref = "scripts/validate_optical_input_readiness_arcgis.py"
    receipt = {
        "receipt_version": "1.0",
        "receipt_id": "NEPAL-S2-MATERIALIZED-INPUT-READINESS-SYNTHETIC-ARCGIS-001",
        ...
        "bindings": {
            "contract_ref": "config/qa/optical-input-readiness-contract.json",
            "contract_sha256": digest("config/qa/optical-input-readiness-contract.json"),
