#!/usr/bin/env python3
"""Activate the exact M2-ORB-001 recovery-003 contract after successful public CI."""
...
from m2_orbit_recovery_003_core import (
    ...
    RECOVERY_002_TERMINAL_REF,
    RECOVERY_002_TERMINAL_SHA256,
    PROPOSAL_REF,
    PROPOSAL_SHA256,
...
def validate_publication_gate(gate: dict[str, Any]) -> str:
    ...
    if (
        ...
        raise ValueError("orbit recovery-003 public-CI gate differs")
    return head
...
def build_outputs(activated_at_utc: str) -> dict[Path, bytes]:
    ...
    contract = {
        ...
        "contract_id": "nepal-m2-orbit-recovery-003",
        ...
        "bindings": {
            ...
            "retained_recovery_002_terminal_ref": RECOVERY_002_TERMINAL_REF,
            "retained_recovery_002_terminal_sha256": RECOVERY_002_TERMINAL_SHA256,
        },
        "does_not_authorize": [
    ...
    activation = {
        "schema_version": "1.0",
        "receipt_id": "NEPAL-M2-ORBIT-RECOVERY-003-ACTIVATION-001",
        "activated_at_utc": activated_at_utc,
        "status": "pass_exact_orbit_recovery_003_activated_final_no_payload_preflight_pending",
        "bindings": {
            "approval_sha256": APPROVAL_SHA256,
            "review_reconciliation_sha256": RECONCILIATION_SHA256,
            "publication_gate_sha256": sha256_file(gate_path),
        ...
        "assertions": {
            ...
            "attempt_event_root_created": False,
            "supervisor_root_created": False,
            "owner_handoff_claim_created": False,
