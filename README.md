...
The separately approved DEM amendment covered four exact Copernicus GLO-30 tiles. All four were acquired anonymously through exclusive staging and no-replace promotion, then verified in ArcGIS Pro 3.7.1 as 3600-by-3600, single-band F32 EPSG:4326 rasters. A full scan found 51,840,000 finite non-NoData cells, and the continuous four-tile footprint covers all approved AOI bounds. These checks do not resolve terrain artifacts, vertical datum, radar processing, or scientific fitness. The current DEM checkpoint is an exact human review of EGM2008 one-minute preconversion; the required optional ArcGIS coordinate-system component is not installed.
...
ArcGIS Pro's installed Sentinel-1 terrain-correction tools also expose a required DEM input. On 3 September 2026 the owner approved the exact four-tile Copernicus DEM GLO-30 amendment and accepted the hash-bound Copernicus WorldDEM-30 license. The fresh preflight then confirmed the license bytes, all four official STAC identities and anonymous objects, 519.029 GiB free space, safe paths, and no collisions. Empty DEM custody and staging directories are initialized outside Git; no DEM payload byte has been requested. The parallel workstream is at `M2-DEM-ACQUISITION`, while the original eight-product acquisition remains independently paused at the secure authentication handoff.
